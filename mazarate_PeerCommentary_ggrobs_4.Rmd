...
Firstly, I think you did better than I when it comes to writing the function. You seem to at least understand the use of the if-else statements. And I believe you're right- I don't think you can have two "else" commands in a row with out an "if" inbetween, or else you're giving two outcomes for one situation. 
